...
class HiddenHolder:
    def __init__(self, unique_id: str, prompt: Any,
                 ...
                 comfy_usage_source: str = None, user_id: str = None, **kwargs):
        ...
        """USER_ID is the identifier of the user who submitted the prompt, used for multi-user file access control."""
    ...
    def from_dict(cls, d: dict | None):
        ...
        return cls(
            ...
            user_id=d.get(Hidden.user_id, None),
        )
